CREATE DATABASE  IF NOT EXISTS `query_practice` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `query_practice`;
-- MySQL dump 10.13  Distrib 8.0.15, for macos10.14 (x86_64)
--
-- Host: localhost    Database: query_practice
-- ------------------------------------------------------
...
-- Dump completed on 2019-09-20  9:40:16
